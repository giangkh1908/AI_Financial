...
- **Việc cần làm kế tiếp:**
  1. M3 — retrieval (thêm deps: rank-bm25, sentence-transformers, FlagEmbedding, faiss-cpu): entity extraction, BM25+dense BGE-M3+RRF+rerank, facts_index, pipeline.
  2. Xác minh câu hỏi kiểm thử của BTC trùng/khác với 1,012 câu HF (chờ BTC).
